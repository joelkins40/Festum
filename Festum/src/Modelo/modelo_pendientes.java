 ...
 * @author Lavaexport
 */
public class modelo_pendientes extends BD{
...
protected ResultSet  consultarNotas(String valor)  {
         String cons="Select * from NOTA,cliente where nota.id_cliente=cliente.id_cliente and estatus_recoleccion<>'Q' and estatus_recoleccion<>'Q'";
...
public void modificar_nota_ACTIVA (String id_folio,String Valor){
               
       String tabla= "nota";
       String valores="estatus_recoleccion='"+Valor+"'";
