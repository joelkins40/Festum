 ...
 * @author Joel
 */
public class PN_CodigoPostal extends javax.swing.JFrame {

    /**
     * Creates new form PN_CodigoPostal
     */
    public PN_CodigoPostal() {
        initComponents();
         cargar_estados();
  ...
  Controlador.controlador_CP CP=new controlador_CP();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PN_CodigoPostal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PN_CodigoPostal().setVisible(true);
            }
        });
    }
