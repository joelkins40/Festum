 ...
 * @author hassiel
 */
public class Ventass_clientes extends javax.swing.JInternalFrame {
...
void cargar_tabla_Ventas(String accion,String FE,String FE2){
    DefaultTableModel model=c.cargar_tabla_totaltota();
    tbdatosnotas.setModel(model);

    TableColumnModel colummodel= tbdatosnotas.getColumnModel();
       
        colummodel.getColumn(0).setPreferredWidth(300);
        colummodel.getColumn(1).setPreferredWidth(10);
        colummodel.getColumn(2).setPreferredWidth(10);
}

public  void cargar_tabla_Ventasxcliente(String cliente){
    DefaultTableModel model=c.cargar_tabla_Ventasxcliente(cliente,"");
    tbdatosnotas.setModel(model);
    sumar_tabla();
    TableColumnModel colummodel= tbdatosnotas.getColumnModel();
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(txtid_Cliente, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtnombrecliente, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(48, 48, 48)
...
if("".equals(txtid_Cliente.getText())){
        ...
        txtid_Cliente.setText("");
txtnombrecliente.setText("");
       Cons_clientes_DB i =  new Cons_clientes_DB();
 Festum.escritorio.add(i);
    ...
    cargar_tabla_Ventasxcliente(txtnombrecliente.getText());
}
